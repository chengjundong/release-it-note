...
4. 发送邮件的目标人数并不等于访问链接的人数，不要低估邮件被转发的次数，如果这是一个真的“爆款”

## Scale effect
1. 扩展系统可以提高性能，同时，使得一个错误导致的问题成平方或立方数增加
2. 警惕P-2-P传输模式，尤其是当服务器很多的时候。可替代的方案是，广播，pub & sub等
3. 在QA环境进行压测，10倍
4. 小心unbalanced capacity。通常，frontend的服务器更多，backend的服务器较少
5. backend需要进行瞬时大流量测试
6. frontend需要测试，当下游系统响应速度很慢的情况
7. 断路器可以保护backend service
8. dogpile, 短时间内大量系统重启会对系统造成冲击，应该让他们错峰
